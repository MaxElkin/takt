...
export const auditedIntegrationBoundaryTestFiles = Object.freeze([
  ...
  'src/__tests__/fork-transition-approval.test.ts',
...
export const fileSystemIntegrationTestFiles = Object.freeze([
  ...
  'src/__tests__/fork-prune-superseded-bundles.test.ts',
  'src/__tests__/fork-task-add.test.ts',
  'src/__tests__/fork-task-config.test.ts',
  'src/__tests__/fork-task-delete.test.ts',
  'src/__tests__/fork-task-list.test.ts',
  'src/__tests__/fork-task-prune.test.ts',
  'src/__tests__/fork-task-run-directories.test.ts',
