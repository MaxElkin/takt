...
const PROVIDER_OPTIONS_ENV_SPEC_ENTRIES = [
  ...
  { path: 'provider_options.antigravity.guards.call_timeout_ms', type: 'number' },
...
const PROVIDER_OPTIONS_TRACE_PATH_ENTRIES = [
  ...
  'provider_options.antigravity.guards',
  'provider_options.antigravity.guards.call_timeout_ms',
...
const PROVIDER_OPTIONS_INTERNAL_PATH_ENTRIES = [
  ...
  'antigravity.guards.callTimeoutMs',
